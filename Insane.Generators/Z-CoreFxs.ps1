...
function Update-ProjectVersion {
    ...
    Update-ProjectBuildNumber -ProjectFilename $ProjectFileName | Out-Null
    ...
    $suffix = [string]::IsNullOrWhiteSpace($versionSuffix.InnerText) ? [string]::Empty : "-$($versionSuffix.InnerText)-Build.$($buildNumber.InnerText)"
    ...
    $version.InnerText = "$($versionPrefix.InnerText)$suffix"
