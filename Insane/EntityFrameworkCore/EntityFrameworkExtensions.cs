...
//public static (Type, DbContextOptionsBuilder) ConfigureDbProvider<TCoreDbContext>(this DbContextSettings settings, DbContextFlavors<TCoreDbContext> flavors, Action<DbContextOptionsBuilder> dbContextOptionsAction, Action<FlavorsDbContextOptionsBuilder> commonOptionsAction = null!)
...
//    FlavorsDbContextOptionsBuilder b = new FlavorsDbContextOptionsBuilder(new DbContextOptionsBuilder());
//    if (commonOptionsAction != null)
//    {
//        commonOptionsAction.Invoke(b);
//    }

//    RelationalOptionsExtension commonExtension = b.GetOptionsExtension()!;
//    switch (settings.Provider)
//    {
//        case DbProvider.SqlServer:
//            builder.UseSqlServer(settings.SqlServerConnectionString, (options) =>
//            {
//                options.CommandTimeout(commonExtension.CommandTimeout);
//                options.
//                options.MigrationsAssembly(commonExtension?.MigrationsAssembly);
//            });
//            return (flavors.SqlServer, builder);
//        //case DbProvider.PostgreSql:
//        //    builder.UseNpgsql(settings.PostgreSqlConnectionString, commonOptionsAction as Action<NpgsqlDbContextOptionsBuilder>);
...
//        //        });
//        //    });
//        //    builder.UseMySql(settings.MySqlConnectionString, ServerVersion.AutoDetect(settings.MySqlConnectionString), commonOptionsAction as Action<MySqlDbContextOptionsBuilder>);
//        //    return flavors.MySql;
//        //case DbProvider.Oracle:
//        //    builder.UseOracle(settings.OracleConnectionString, commonOptionsAction as Action<OracleDbContextOptionsBuilder>);
