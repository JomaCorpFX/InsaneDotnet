...
";
        ...
        Console.WriteLine(aesCbcEncryptor.Decrypt(aesCbcEncryptor.Encrypt(datax.ToByteArrayUtf8())).ToStringFromUtf8());
        Console.WriteLine(aesCbcEncryptor.DecryptEncoded(aesCbcEncryptor.EncryptEncoded(datax)));
        Console.WriteLine(aesCbcEncryptor2.Decrypt(aesCbcEncryptor2.Encrypt(datax.ToByteArrayUtf8())).ToStringFromUtf8());
        ...
        Console.WriteLine(rsaEncryptor.Decrypt(rsaEncryptor.Encrypt(datax.ToByteArrayUtf8())).ToStringFromUtf8());
        Console.WriteLine(rsaEncryptor.DecryptEncoded(rsaEncryptor.EncryptEncoded(datax)));
        Console.WriteLine(rsaEncryptor2.Decrypt(rsaEncryptor2.Encrypt(datax.ToByteArrayUtf8())).ToStringFromUtf8());
