...
namespace InsaneIO.Insane.Tests
{
    ...
    public class RsaExtensionsUnitTests
    {
        ...
        private void CreateKeyPair(uint size, RsaKeyPairEncoding encoding, bool indented)
        {
        ...
        {
            CreateKeyPair(KeySize, RsaKeyPairEncoding.Ber, true);
        }

        [TestMethod]
        public void TestCreateKeyPairBerEncodedNotIndented()
        {
            CreateKeyPair(KeySize, RsaKeyPairEncoding.Ber, false);
        }

        [TestMethod]
        public void TestCreateKeyPairPemEncodedIndented()
        {
            CreateKeyPair(KeySize, RsaKeyPairEncoding.Pem, true);
        }

        [TestMethod]
        public void TestCreateKeyPairPemEncodedNotIndented()
        {
            CreateKeyPair(KeySize, RsaKeyPairEncoding.Pem, false);
        }

        [TestMethod]
        public void TestCreateKeyPairXmlEncodedIndented()
        {
            CreateKeyPair(KeySize, RsaKeyPairEncoding.Xml, true);
        }

        [TestMethod]
        public void TestCreateKeyPairXmlEncodedNotIndented()
        {
            CreateKeyPair(KeySize, RsaKeyPairEncoding.Xml, false);
        }
