...
namespace InsaneIO.Insane.Tests
{
    ...
    public class RsaExtensionsUnitTests
    {
        ...
        {
            EncryptDecryptRsa(Data, PublicKeyJsonIndented, PrivateKeyJsonIndented, Base64Encoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptJsonEncodedKeyNotIndentedBase64Encoder()
        {
            EncryptDecryptRsa(Data, PublicKeyJsonNotIndented, PrivateKeyJsonNotIndented, Base64Encoder.DefaultInstance);
        }
        ...
        {
            EncryptDecryptRsa(Data, PublicKeyXmlIndented, PrivateKeyXmlIndented, Base64Encoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptXmlEncodedKeyNotIndentedBase64Encoder()
        {
            EncryptDecryptRsa(Data, PublicKeyXmlNotIndented, PrivateKeyXmlNotIndented, Base64Encoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptBerEncodedKeyHexEncoder()
        {
            EncryptDecryptRsa(Data, PublicKeyBer, PrivateKeyBer, HexEncoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptJsonEncodedKeyIndentedHexEncoder()
        {
            EncryptDecryptRsa(Data, PublicKeyJsonIndented, PrivateKeyJsonIndented, HexEncoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptJsonEncodedKeyNotIndentedHexEncoder()
        {
            EncryptDecryptRsa(Data, PublicKeyJsonNotIndented, PrivateKeyJsonNotIndented, HexEncoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptPemEncodedKeyHexEncoder()
        {
            EncryptDecryptRsa(Data, PublicKeyPem, PrivateKeyPem, HexEncoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptXmlEncodedKeyIndentedHexEncoder()
        {
            EncryptDecryptRsa(Data, PublicKeyXmlIndented, PrivateKeyXmlIndented, HexEncoder.DefaultInstance);
        }

        [TestMethod]
        public void TestRsaEncryptXmlEncodedKeyNotIndentedHexEncoder()
        {
            EncryptDecryptRsa(Data, PublicKeyXmlNotIndented, PrivateKeyXmlNotIndented, HexEncoder.DefaultInstance);
        }
        ...
        public void TestKey()
        {
            ...
            var encrypted = Data.EncryptRsa(publicKey, Base64Encoder.DefaultInstance);
            Assert.AreEqual(Data, encrypted.DecryptRsa(privateKey, Base64Encoder.DefaultInstance));
        }
    }
}
